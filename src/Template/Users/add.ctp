...
<?= $this->Form->create($user) ?>
        ...
        <legend style="font-size: 30px; font-weight: bold"><?= __('Sign up') ?></legend>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <?=  $this->Form->control('login', ['placeholder' => 'Username', 'label' => '' ]); ?>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <?=  $this->Form->control('mail', ['placeholder' => 'Email address', 'label' => false ]); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <?=  $this->Form->control('sex', ['options' => ['undefined' => 'Undefined', 'male' => 'Male', 'female' => 'Female'],'label' => false])  ?>
                        </div>
                    </div>
    ...
    <div class="'col-md-2">
        <span><?= $this->Form->button(__('Submit')) ?> </span>
        <span><?= $this->Form->button('Reset the Form', ['type' => 'reset']) ?></span>
    ...
    <?= $this->Form->create($user) ?>
     ...
     <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('age'); //comprobar que no peude ser negativo
            //echo $this->Form->hidden('role');
            echo $this->Form->control('sex', ['options' => ['undefined' => 'Undefined', 'male' => 'Male', 'female' => 'Female']]);
            echo $this->Form->control('country'); //añadir lista de países
            echo $this->Form->hidden('creado', ['value' => date("Y-m-d H:i:s")]);
