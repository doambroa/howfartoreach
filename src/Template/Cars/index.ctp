    ...
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr style="display: "";"  class="carBrands" id="car_<?=$i?>">
                ...
                <td class="consumoCiudad"><?= $this->Number->format($car->consumoCiudad) ?></td>      <!-- aquí habra que meter las medias de la table de carsusers -->
                <td class="consumoAutopista"><?= $this->Number->format($car->consumoAutopista) ?></td>
                <td class="consumoCombinado"><?= $this->Number->format($car->combinado) ?></td>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink('Delete', ['action' => 'delete', $car->id], ['confirm' => 'Are you sure you want to delete register number ' . $car->id . '?', 'class' => 'btn btn-sm btn-danger']) ?>
