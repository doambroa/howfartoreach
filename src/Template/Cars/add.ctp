            ...
            <legend><?= __('Add new car in the market') ?><div class="ajax_loading_image"></div></legend>
                <div class="form-group select">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-tag"></span><?php echo $this->Form->control('marca',['label'=>'Brand','required']);?></span>
                    </div>
                </div>
                <div class="form-group select">
                    <span style="font-weight: bold;"></span>
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-tags"></span><?php echo $this->Form->control('modelo',['label'=>'Model','required'=>true]);?></span>
                    </div>
                </div>
